...
// ---- KYC-required modal ----------------------------------------------
const KycRequiredModal = ({ onClose, onGoToKyc }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
    ...
    <div className="relative w-full max-w-[380px] rounded-[3px] bg-surface border border-border shadow-xl p-7 text-center animate-[modalIn_0.25s_ease_forwards]">
      ...
      <p className="text-[13px] leading-relaxed text-ink-soft mb-6">
        Listing products is unlocked once your pickup address, payout
        details, and PAN are verified — it only takes a few minutes.
      </p>
...
const SellerDashboard = () => {
  ...
  const goToKyc = () => navigate("/become-seller/verify");
