      ...
      <div className="flex items-center justify-center px-6 py-12 md:px-10 md:py-16 lg:px-16">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.1em] text-ink-soft">
                Full Name
              </label>
              <input
                id="fullName"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.1em] text-ink-soft">
                Email Address
              </label>
              <input
                id="email"
            ...
            {/* Phone */}
            <div>
              <label htmlFor="phone" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.1em] text-ink-soft">
                Phone Number
              </label>
              <div
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.1em] text-ink-soft">
                Password
              </label>
              <div
                className={`flex items-center overflow-hidden rounded-[3px] border bg-cream-dark transition-colors focus-within:border-ink ${
